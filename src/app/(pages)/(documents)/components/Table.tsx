...
export default function Table({edital, descricao, url1, url2}: TableProps) {
    return (
        <table className="hidden lg:block lg:min-w-full lg:table-auto">
            <tbody>
                <tr
                    className='rounded-lg odd:bg-transparent even:bg-gray'
                >
                    <td className="!w-2/5 bg-red-100">
                        <p className="font-semibold">{edital}</p>
                    </td>
                    <td className="w-2/5 bg-green-200">
                        <p className='line-clamp-1'>{descricao}</p>
                    </td>
                    <td className="w-1/5 py-5 bg-yellow-100">
                        <div className="flex justify-end">
                            ...
                            <Link href={url2} download rel='noopener noreferrer' className="ml-3">
                                <svg
                                    width="24"
                                    height="16"
                                    viewBox="0 0 24 16"
